...
import com.mrzak34.thunderhack.module.modules.render.PopChams;
...
public class TotemPopCham {
    ...
    public void onRenderWorld(final RenderWorldLastEvent event) {
        ...
        Color lineColorS = new Color((int) PopChams.rL.getValue(),(int) PopChams.bL.getValue(),(int) PopChams.gL.getValue(),(int) PopChams.aL.getValue());
        Color fillColorS = new Color((int) PopChams.rF.getValue(),(int) PopChams.bF.getValue(),(int) PopChams.gF.getValue(),(int) PopChams. aF.getValue());
