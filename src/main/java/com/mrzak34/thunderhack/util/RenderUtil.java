...
public class RenderUtil
    ...
    // public static void drawNametag(Entity entity, String[] text, color, int type) {
    ...
    */ //TODO в пизду
    ...
    public static void rectangleBordered(double x, double y, double x1, double y1, double width, int internalColor, int borderColor) {
        RenderUtil.drawRect((float) (x + width), (float) (y + width), (float) (x1 - width), (float) (y1 - width), internalColor);
        RenderUtil.drawRect((float) (x + width), (float) y, (float) (x1 - width), (float) (y + width), borderColor);
        RenderUtil.drawRect((float) x, (float) y, (float) (x + width), (float) y1, borderColor);
        RenderUtil.drawRect((float) (x1 - width), (float) y, (float) x1, (float) y1, borderColor);
        RenderUtil.drawRect((float) (x + width), (float) (y1 - width), (float) (x1 - width), (float) y1, borderColor);
    }
    ...
    public static Color getHealthColor(EntityLivingBase entityLivingBase) {
        ...
        return health >= 0.0f ? RenderUtil.blendColors(fractions, colors, progress).brighter() : colors[0];
    }
    public static Color blendColors(float[] fractions, Color[] colors, float progress) {
        ...
        int[] indicies = RenderUtil.getFractionIndicies(fractions, progress);
        float[] range = new float[]{fractions[indicies[0]], fractions[indicies[1]]};
        Color[] colorRange = new Color[]{colors[indicies[0]], colors[indicies[1]]};
        float max = range[1] - range[0];
        float value = progress - range[0];
        float weight = value / max;
        return RenderUtil.blend(colorRange[0], colorRange[1], 1.0f - weight);
    }
    ...
    public static double interpolate(double prevPosX, double posX, float partialTicks) {
