...
class BoatFly
    ...
    public NumberSetting speed = new NumberSetting("Speed", 3.0, 1.0, 10.0, 1.0);
    public NumberSetting verticalSpeed = new NumberSetting("VerticalSpeed", 3.0, 1.0, 10.0, 1.0);
    public BooleanSetting doAntiFactor = new BooleanSetting("Factorize", true);
    public BooleanSetting noKick = new BooleanSetting("Kick", true);
    public BooleanSetting packet = new BooleanSetting("Packet", true);
    public NumberSetting packets = new NumberSetting("Packets", 3, 1, 5, 1);
    public NumberSetting interact = new NumberSetting("Delay", 2, 1, 20, 1);

    private int teleportID;

    public
    BoatFly ( ) {
        super ( "BoatFly" , 0 , Category.MOVEMENT, false );
        this.addSettings(speed,verticalSpeed,doAntiFactor,noKick,packet,packets,interact);
        INSTANCE = this;
    }
