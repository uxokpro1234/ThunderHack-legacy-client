...
import com.mrzak34.thunderhack.util.NordTessellator;
import com.mrzak34.thunderhack.util.TotemPopCham;
...
public class PopChams extends Module {
    ...
    public static final NumberSetting rL = new NumberSetting("RedLine", 0, 0, 255, 1);
    public static final NumberSetting gL = new NumberSetting("GreenLine", 0, 0, 255, 1);
    public static final NumberSetting bL = new NumberSetting("BlueLine", 255, 0, 255, 1);
    public static final NumberSetting aL = new NumberSetting("AlphaLine", 255, 0, 255, 1);

    public static final NumberSetting rF = new NumberSetting("RedFill", 255, 0, 255, 1);
    public static final NumberSetting gF = new NumberSetting("GreenFill", 255, 0, 255, 1);
    public static final NumberSetting bF = new NumberSetting("BlueFill", 255, 0, 255, 1);
    public static final NumberSetting aF = new NumberSetting("AlphaFill", 42, 0, 255, 1);

    public static final NumberSetting fadestart = new NumberSetting("FadeStart", 200, 0, 3000, 1);
    public static final NumberSetting fadetime = new NumberSetting("FadeStart", .5, .0,2d, 1);
    public static final BooleanSetting onlyOneEsp = new BooleanSetting("OnlyOneEsp", true);
    public static final BooleanSetting rainbow = new BooleanSetting("Rainbow", false);
    ...
    public PopChams() {
        super("PopChams",0 , Category.RENDER, false);
        this.addSettings(self, rL, gL , bL , aL, rF, gF, bF, aF, fadestart, fadetime, onlyOneEsp, rainbow);
    }
    ...
    public void onPacketReceived(PacketEvent.Receive event) {
        if (event.getPacket() instanceof SPacketEntityStatus) {
            ...
            if (packet.getOpCode() == 35 && packet.getEntity(PopChams.mc.world) != null && (self.isEnabled() || packet.getEntity(PopChams.mc.world).getEntityId() != PopChams.mc.player.getEntityId())) {
    ...
    public void onRenderWorld(RenderWorldLastEvent event) {
        if (onlyOneEsp.isEnabled()) {
            ...
            Color lineColorS = new Color ((int) rL.getValue(),(int) bL.getValue(),(int) gL.getValue(),(int) aL.getValue());
            Color fillColorS = new Color((int) rF.getValue(),(int) bF.getValue(),(int) gF.getValue(),(int) aF.getValue());
